...
export default function ProjectPage() {
  ...
  const projects = {
    aisuite: {
      ...
      technologies: ["Next.js 14", "React", "Tailwind CSS", "Python", "LLMs", "Machine Learning"],
      category: "app",
      github: "#",
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Galería de imágenes / Video / Mobile */}
      <div className="space-y-4">
        <div className="terminal-window p-0 overflow-hidden">
          <div className="terminal-header">
            ...
            <div className="terminal-button terminal-button-yellow"></div>
            <div className="terminal-button terminal-button-green"></div>
            <div className="terminal-title">{('videoUrl' in project && project.videoUrl) ? 'project_demo.mp4' : 'project_screenshots.sh'}</div>
            {/* Control de autoplay */}
            {!('videoUrl' in project && project.videoUrl) && projectImages.length > 1 && (
          ...
          {/* VIDEO MODE - para proyectos con videoUrl (ej: AISUITE) */}
          {('videoUrl' in project && project.videoUrl) ? (
            <div className="relative w-full bg-[rgba(13,10,30,0.8)] overflow-hidden border border-accent-500/30">
            ...
            /* MOBILE MODE - para proyectos con diseño móvil (ej: Battlekart) */
            ...
            /* STANDARD MODE - galería landscape normal */
            <div className="relative aspect-video w-full bg-[rgba(13,10,30,0.8)] overflow-hidden">
              <div className="relative aspect-video w-full bg-drcv-600 overflow-hidden border border-accent-500/30">
                ...
                {projectImages.length > 1 && (
                  <div className="absolute top-4 right-4 bg-drcv-600/90 backdrop-blur-sm px-3 py-1 rounded-md text-sm text-accent-500 font-mono border border-accent-500/30 z-10">
        ...
        {/* Miniaturas - solo en modo estándar (NO video, NO mobile) */}
        {!('videoUrl' in project && project.videoUrl) && !('isMobileDesign' in project && project.isMobileDesign) && projectImages.length > 1 && (
