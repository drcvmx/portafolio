...
export default function ProjectPage() {
  ...
  const projects = {
    ...
    pos: {
      ...
      images: [
        "/project_webp/store/01.png",
        "/project_webp/store/02.png",
    ...
    greekos: {
      ...
      images: [
        "/project_webp/greekos/greekos1.png",
      ],
      technologies: ["React 18", "TypeScript 5", "Vite 5", "Tailwind CSS 3.4", "shadcn/ui", "Radix UI", "React Router DOM v6", "React Hook Form", "Zod", "Lucide React", "TanStack React Query", "OpenStreetMap embed"],
      category: "web",
      github: "#",
      demo: "#",
    ...
    jrl_mexico: {
      ...
      images: [
        "/project_webp/jrl/jrl1.png",
      ],
      technologies: ["React 18", "TypeScript 5", "Vite 5", "Tailwind CSS v3", "shadcn/ui", "Radix UI", "Zustand", "TanStack Query", "React Hook Form", "Zod", "Framer Motion", "Embla Carousel", "Supabase (PostgreSQL)", "Supabase Auth", "Supabase Storage", "Supabase Edge Functions (Deno)", "Shopify Storefront API (GraphQL)", "Shopify Admin API REST", "Vitest", "Testing Library"],
      category: "app",
      github: "#",
      demo: "#",
