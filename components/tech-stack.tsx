...
export function TechStack() {
  ...
  const technologies: TechItem[] = [
    ...
    { name: "Next.js", icon: "skills_webp/nextjs-icon-svgrepo-com.svg", color: "text-accent-500" },
    { name: "Vue", icon: "skills_webp/vue.webp", color: "text-accent-400" },
    { name: "Astro", icon: "skills_webp/astro.webp", color: "text-accent-400" },
    ...
    { name: "GitHub", icon: "skills_webp/github.webp", color: "text-accent-500" },
  ]
  ...
  return (
    <div className="flex justify-center">
      <div className="bg-cyber-dark/80 border border-accent-500/30 rounded-lg p-8 max-w-xs w-full text-center backdrop-blur-sm relative overflow-hidden">
        {/* Efecto de brillo de fondo */}
        <div className="absolute inset-0 bg-gradient-to-br frshadow-accent-purple/5 via-transparent to-neon-purple/5"></div>
